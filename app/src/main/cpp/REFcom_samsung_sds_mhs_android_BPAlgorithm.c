...
extern char EstimateBP(int *data, unsigned short num_data, unsigned short *sbp, unsigned short *dbp, unsigned short *hr, double *feat1, double *feat2, double *feat3, double *feat4, char reset);
...
JNIEXPORT char JNICALL Java_com_samsung_sds_mhs_android_BPAlgorithm_estimateBP
  (JNIEnv *env, jobject obj, jintArray data,jshort num_data,jshortArray sbp, jshortArray dbp, jshortArray hr, jdoubleArray feat1, jdoubleArray feat2, jdoubleArray feat3, jdoubleArray feat4, jchar reset) {
        ...
        unsigned short* pSBP;
        pSBP = (unsigned short *)malloc(sizeof(unsigned short) * 1); // output
        short* pDBP;
        ...
        *pFeat4 = *((*env)->GetDoubleArrayElements(env, feat4, NULL));
        ...
        char ret = EstimateBP(pdata,num_data,pSBP,pDBP,pHR, pFeat1, pFeat2, pFeat3, pFeat4, reset);
